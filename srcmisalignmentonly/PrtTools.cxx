...
void PrtTools::SetupCustomStyle() {
    ...
    customStyle->SetTitleFont(132, "x");
    customStyle->SetTitleFont(132, "y");
    customStyle->SetTitleFont(132, "z");
    ...
    customStyle->SetGridColor(kGray); 

    
    gROOT->SetStyle("CustomStyle");
    gStyle->cd();

    gStyle->SetPalette(84); //112,84
